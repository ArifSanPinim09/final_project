          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(
                  "Rp. ${controller.listLapangan["harga"]!}",
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text("${controller.listLapangan["jarak"]!} km",
                              style: const TextStyle(
                                  fontFamily: 'mulish',
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15)),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border(
                              top: BorderSide(color: Appcolors.gray, width: 2),
                              bottom:
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: index >= 0 && index <= 1
                                            ? Text(controller
                                                    .facilitylist[index].key +
                                                " : " +
                                                controller
                                                    .facilitylist[index].value
                                                    .toString())
                                            : controller.facilitylist[index]
                                                        .value ==
                                                    true
                        ...
                        return Flexible(
                          child: (Center(
                            child: GridView.builder(
                                ...
                                scrollDirection: Axis.vertical,
                                itemBuilder: (context, index) {
                                  final item = controller.listreview[
